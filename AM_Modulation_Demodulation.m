...
Initialize_AM_Modulation_Demodulation; %%% Including this file to initialize all the required variables and objects
...
modulated_signal = ammod(signal_data, carrier_frequency, sampling_frequency); %%% Modulating data bits using AM modulator
...
demodulated_signal = amdemod(recevied_signal, carrier_frequency, sampling_frequency); %%% Demodulating the received data using AM demodulator

figure('Name','Visualizing AM Modulation and Demodulation','NumberTitle','off','Position', ...
