...
Initialize_FM_Modulation_Demodulation; %%% Including this file to initialize all the required variables and objects

%%%-----------FM Modulation and Demodulation for a fixed point SNR-----------%%%
signal_data = signal_amplitude * sin(2 * pi * signal_frequency * time_vector); %%% Generating sample sinusoidal signal

modulated_signal = fmmod(signal_data, carrier_frequency, sampling_frequency, frequency_deviation); %%% Modulating data bits using FM modulator
...
demodulated_signal = fmdemod(recevied_signal, carrier_frequency, sampling_frequency, frequency_deviation); %%% Demodulating the received data using FM demodulator

figure('Name','Visualizing FM Modulation and Demodulation','NumberTitle','off','Position', ...
...
%%%-----------AM Modulation and Demodulation for a fixed point SNR-----------%%%